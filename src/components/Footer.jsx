    ...
    <footer className="bg-white py-12 border-t border-neutral-200">
      <div className="mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:w-[50%] lg:w-full lg:flex-row justify-between gap-8">
          ...
          <div>
            <h4 className="text-xs font-bold text-neutral-900 uppercase tracking-widest mb-6">Find Us On</h4>
            <ul className="space-y-4 text-sm text-neutral-500">
              <li><Link className="hover:text-neutral-900" to="/about">Facebook Page</Link></li>
              <li><Link className="hover:text-neutral-900" to="/about">Facebook Group</Link></li>
        ...
        <div className="mt-10 flex flex-wrap items-center justify-between gap-4 border-t border-neutral-200 pt-6 text-sm text-neutral-500">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link to="/terms-and-conditions" className="hover:text-neutral-700">Terms & Conditions</Link>
